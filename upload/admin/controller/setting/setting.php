...
class ControllerSettingSetting extends Controller {
	...
	public function theme() {
		...
		elseif ($this->request->get['theme'] == 'theme_mahardhi') {
			$theme = $this->config->get('theme_mahardhi_directory');
		}
		else {
		...
		elseif(is_file(DIR_CATALOG . 'view/theme/' . $theme . '/image/mahardhi/' . $theme . '.png')) {
			$this->response->setOutput($server . 'catalog/view/theme/' . $theme . '/image/mahardhi/' . $theme . '.png');
		}
		else {
