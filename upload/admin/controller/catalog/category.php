...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		} elseif (!empty($category_info) && !empty($category_info['banner'])) {
		...
		if (isset($this->request->post['banner']) && is_file(DIR_IMAGE . $this->request->post['banner'])) {
			$data['thumbBanner'] = $this->model_tool_image->resize($this->request->post['banner'], 100, 100);
		} elseif (!empty($category_info) && !empty($category_info['banner']) && is_file(DIR_IMAGE . $category_info['banner'])) {
			$data['thumbBanner'] = $this->model_tool_image->resize($category_info['banner'], 100, 100);
		} else {
