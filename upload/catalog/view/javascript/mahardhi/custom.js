(function ($) {
	...
	$(document).ready(function() {
		$('.product-tab-block, .html1').wrapAll("<div class='protab-html1 mt-80 parallax'><div class='container'><div class='row'></div></div></div>");
		
		$('.footer_link').insertAfter('.powered');
